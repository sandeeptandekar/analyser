...
class gsp_loganalyser_productindex_gsp extends GroovyPage {
...
printHtmlPart(13)
invokeTag('sortableColumn','g',29,['property':("productVersion"),'title':(message(code: 'product.productVersion.label', default: 'Product Version'))],-1)
printHtmlPart(14)
loop:{
int i = 0
...
invokeTag('link','g',37,['action':("show"),'id':(productInstance.id)],3)
printHtmlPart(17)
expressionOut.print(fieldValue(bean: productInstance, field: "productVersion"))
printHtmlPart(18)
i++
}
}
printHtmlPart(19)
invokeTag('paginate','g',46,['total':(productInstanceCount ?: 0)],-1)
printHtmlPart(20)
})
