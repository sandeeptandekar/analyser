...
class gsp_loganalyser_logCasesummary_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/logCase/summary.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(21)
invokeTag('set','g',69,['var':("counter"),'value':(1)],-1)
printHtmlPart(22)
for( i in (a.value) ) {
printHtmlPart(23)
expressionOut.print(i.value)
...
public static final long LAST_MODIFIED = 1422355252000L
