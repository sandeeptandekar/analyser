...
class gsp_loganalyser_logCasecategory_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/logCase/category.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(13)
if(true && (black?.category)) {
printHtmlPart(14)
invokeTag('message','g',28,['code':("exceptionRef.category.label"),'default':("Category")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(black),'field':("category")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (black?.description)) {
printHtmlPart(18)
invokeTag('message','g',37,['code':("exceptionRef.description.label"),'default':("Description")],-1)
printHtmlPart(19)
invokeTag('fieldValue','g',39,['bean':(black),'field':("description")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (black?.key)) {
...
printHtmlPart(21)
invokeTag('fieldValue','g',48,['bean':(black),'field':("key")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (black?.product)) {
printHtmlPart(22)
...
invokeTag('link','g',57,['controller':("product"),'action':("show"),'id':(black?.product?.id)],3)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (black?.resolution)) {
printHtmlPart(24)
invokeTag('message','g',64,['code':("exceptionRef.resolution.label"),'default':("Resolution")],-1)
printHtmlPart(25)
invokeTag('fieldValue','g',66,['bean':(black),'field':("resolution")],-1)
printHtmlPart(16)
}
printHtmlPart(26)
createTagBody(2, {->
...
public static final long LAST_MODIFIED = 1420439833000L
