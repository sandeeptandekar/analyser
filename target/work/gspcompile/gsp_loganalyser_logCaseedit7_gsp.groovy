...
class gsp_loganalyser_logCaseedit7_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/logCase/edit7.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(31)
invokeTag('actionSubmit','g',117,['class':("delete"),'action':("show3"),'value':("update")],-1)
printHtmlPart(32)
})
...
public static final long LAST_MODIFIED = 1423051256000L
