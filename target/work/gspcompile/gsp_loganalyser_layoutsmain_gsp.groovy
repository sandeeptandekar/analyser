...
class gsp_loganalyser_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(2)
invokeTag('captureMeta','sitemesh',23,['gsp_sm_xmlClosingForEmptyTag':(""),'name':("viewport"),'content':("width=device-width,initial-scale=1.0")],-1)
printHtmlPart(3)
...
printHtmlPart(1)
invokeTag('javascript','g',30,['library':("application")],-1)
printHtmlPart(9)
invokeTag('layoutResources','r',31,[:],-1)
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1421930759000L
