...
class gsp_loganalyser_productcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(productInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(productInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:productInstance, action:'save'])],2)
printHtmlPart(22)
})
