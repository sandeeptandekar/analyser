...
class gsp_loganalyser_analyser_Untitled_Foldercreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/analyser/Untitled Folder/create.gsp" }
public Object run() {
Writer out = getOut()
