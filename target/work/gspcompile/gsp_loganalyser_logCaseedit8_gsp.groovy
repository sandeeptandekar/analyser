...
class gsp_loganalyser_logCaseedit8_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/logCase/edit8.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(31)
invokeTag('actionSubmit','g',117,['class':("delete"),'action':("show4"),'value':("update")],-1)
printHtmlPart(32)
})
...
public static final long LAST_MODIFIED = 1423052085000L
