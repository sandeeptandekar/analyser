...
class gsp_loganalyser_productshow_gsp extends GroovyPage {
...
printHtmlPart(17)
if(true && (productInstance?.productVersion)) {
printHtmlPart(18)
invokeTag('message','g',37,['code':("product.productVersion.label"),'default':("Product Version")],-1)
printHtmlPart(19)
invokeTag('fieldValue','g',39,['bean':(productInstance),'field':("productVersion")],-1)
printHtmlPart(16)
}
printHtmlPart(20)
createTagBody(2, {->
...
invokeTag('link','g',47,['class':("edit"),'action':("edit"),'resource':(productInstance)],3)
printHtmlPart(22)
...
invokeTag('form','g',50,['url':([resource:productInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(24)
})
