	...
	<body>
		...
		<div id="show-exceptionRef" class="content scaffold-show" role="main">
			...
			<ol class="property-list exceptionRef">
				...
				<g:if test="${black?.category}">
				<li class="fieldcontain">
					<span id="category-label" class="property-label"><g:message code="exceptionRef.category.label" default="Category" /></span>
					
						<span class="property-value" aria-labelledby="category-label"><g:fieldValue bean="${black}" field="category"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${black?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="exceptionRef.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${black}" field="description"/></span>
				...
				<li class="fieldcontain">
					<span id="key-label" class="property-label"><g:message code="exceptionRef.key.label" default="Key" /></span>
						...
						<span class="property-value" aria-labelledby="key-label"><g:fieldValue bean="${black}" field="key"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${black?.product}">
				<li class="fieldcontain">
					<span id="product-label" class="property-label"><g:message code="exceptionRef.product.label" default="Product" /></span>
					
						<span class="property-value" aria-labelledby="product-label"><g:link controller="product" action="show" id="${black?.product?.id}">${exceptionRefInstance?.product?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${black?.resolution}">
				<li class="fieldcontain">
					<span id="resolution-label" class="property-label"><g:message code="exceptionRef.resolution.label" default="Resolution" /></span>
					
						<span class="property-value" aria-labelledby="resolution-label"><g:fieldValue bean="${black}" field="resolution"/></span>
