	...
	<body>
		...
		<div id="show-product" class="content scaffold-show" role="main">
			...
			<ol class="property-list product">
				...
				<g:if test="${productInstance?.productVersion}">
				<li class="fieldcontain">
					<span id="productVersion-label" class="property-label"><g:message code="product.productVersion.label" default="Product Version" /></span>
					
						<span class="property-value" aria-labelledby="productVersion-label"><g:fieldValue bean="${productInstance}" field="productVersion"/></span>
